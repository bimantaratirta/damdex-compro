...
export const FiftSection = () => {
  ...
  return (
    <Box sx={{ width: "100vw", height: { xs: "87vh", sm: "120vh" } }}>
      {mobile && (
        <Stack direction={"column"} alignItems={"center"} justifyContent={"center"} spacing={1} pt={"2vh"} pb={"2vh"} data-aos="fade-up" data-aos-easing="ease-in-out">
      ...
      {!mobile && (
        <Stack direction={"row"} alignItems={"center"} justifyContent={"center"} spacing={1} pt={"2vh"} pb={"2vh"} data-aos="fade-up" data-aos-easing="ease-in-out">
          <Typography variant="h2" fontWeight={800}>
            Gallery
          </Typography>
          <Typography
        ...
        {mobile && (
          <Stack direction={"column"} spacing={3}>
            <Box sx={{ width: "80vw", height: "20vh", position: "relative" }}>
              <Image alt="gallery1" src={gallery1} fill data-aos="fade-right" data-aos-easing="ease-in-out" />
            </Box>
            <Box sx={{ width: "80vw", height: "20vh", position: "relative" }}>
              <Image alt="gallery1" src={gallery2} fill data-aos="fade-right" data-aos-easing="ease-in-out" />
            </Box>
            <Box sx={{ width: "80vw", height: "20vh", position: "relative" }}>
              <Image alt="gallery1" src={gallery3} fill data-aos="fade-right" data-aos-easing="ease-in-out" />
            </Box>
          </Stack>
        )}
        {!mobile && (
