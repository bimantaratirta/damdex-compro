...
const Page = () => {
  return (
    <AppLayout>
      <Box sx={{ width: "100vw", background: `url(${background.src})`, backgroundRepeat: "no-repeat", backgroundSize: "cover", height: { xs: "90vh", md: "135vh", lg: "75vh" } }}>
        <Typography fontSize={"80px"} fontWeight={500} textAlign={"center"} pt={22.5} width={"60vw"} margin={"auto"}>
      ...
      >
        <Stack alignItems={"center"} justifyItems={"center"} direction={"column"} spacing={4} sx={{ pt: { xs: "10vh", sm: "21.5vh" } }}>
